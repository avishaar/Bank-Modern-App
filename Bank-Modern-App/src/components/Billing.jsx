  ...
  <section id='product' className={layout.sectionReverse}>
    ...
    <div className={layout.sectionInfo}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        Billing and invoicing are crucial aspects of financial management, enabling businesses to accurately track and record transactions, issue invoices to clients, and ensure timely payment collection.
      </p>
